// FineTune/Audio/Engine/AudioEngine+InputLock.swift
import AudioToolbox
import Foundation
import os
...
extension AudioEngine {
    func handleDefaultInputDeviceChanged(_ newDefaultInputUID: String) {
    ...
    func applyInputDeviceLock(_ device: AudioDevice) {
    ...
    func handleInputDeviceConnected(_ deviceUID: String, name deviceName: String) {
        guard settingsManager.appSettings.lockInputDevice else { return }
    ...
    func handleInputDeviceDisconnected(_ deviceUID: String) {
