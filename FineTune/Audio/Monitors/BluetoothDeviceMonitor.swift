...
final class BluetoothDeviceMonitor {
    ...
    /// `nonisolated(unsafe)` lets deinit remove them without crossing actor isolation.
    ...
    private nonisolated static func fetchPairedAudioDevices(
        ...
        let a2dpSinkUUID = IOBluetoothSDPUUID(uuid16: 0x110B)!
        let hfpUUID = IOBluetoothSDPUUID(uuid16: 0x111E)!
