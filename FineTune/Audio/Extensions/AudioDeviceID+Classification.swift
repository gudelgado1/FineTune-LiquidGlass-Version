...
extension AudioDeviceID {
    ...
    nonisolated func isHidden() -> Bool {
...
extension AudioDeviceID {
    ...
    nonisolated func supportsAutoEQ() -> Bool {
    ...
    nonisolated func builtInHasHeadphonesActive() -> Bool {
...
extension AudioDeviceID {
    ...
    func suggestedIconSymbol() -> String {
        ...
        // Wired / external headphones (3.5 mm jack, USB-C, dongle). macOS names
        // these "External Headphones"; use Apple's headphones glyph rather than
        // the transport default (built-in would otherwise fall to a speaker).
