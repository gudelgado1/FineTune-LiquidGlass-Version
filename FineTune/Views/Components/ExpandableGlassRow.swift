...
struct ExpandableGlassRow<Header: View, ExpandedContent: View>: View {
    ...
    var body: some View {
        ...
        // Rectangle content shape ensures the full padded frame — including the
        // vertical padding around the last row in a VStack — is always registered
        // as a hit-test area. Without this, macOS may use the inner content bounds
        // and miss hover events at the edges (especially the bottom of the last row).
