        ...
        VStack(spacing: 4) {
            GeometryReader { geo in
                ...
                Color.clear
                    ...
                    // Double-click a band to reset it to 0 dB (flat — no gain/cut).
                    // Simultaneous so single-tap / drag to set still works; on a
                    // double-tap the drag may briefly move the thumb, then this
                    // snaps it back to 0 with a short animation.
                    .simultaneousGesture(
