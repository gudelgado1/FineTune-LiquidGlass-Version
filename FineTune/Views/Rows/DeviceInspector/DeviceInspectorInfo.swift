...
extension DeviceInspectorInfo {
    ...
    nonisolated static func formatPhysicalFormat(_ asbd: AudioStreamBasicDescription?) -> String? {
    ...
    nonisolated static func formatHogModeOwner(_ owner: pid_t, processName: String?) -> String? {
...
nonisolated struct InfoGridLayout: Equatable {
    nonisolated enum Row: Equatable {
